...
```sh
npm install git+ssh://git@github.com:bila-devdraft/sdk-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/bila-devdraft/sdk-typescript/issues) with questions, bugs, or suggestions.
