...
describe('resource transfers', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.v1.bila.transfers.retrieve('68f11209-451f-4a15-bfcd-d916eb8b09f4');
  ...
  test.skip('list', async () => {
    const responsePromise = client.v1.bila.transfers.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getStatusByReference', async () => {
    const responsePromise = client.v1.bila.transfers.getStatusByReference('transfer-001');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('initiateBankTransfer: only required params', async () => {
    const responsePromise = client.v1.bila.transfers.initiateBankTransfer({
      accountId: '68f11209-451f-4a15-bfcd-d916eb8b09f4',
      amount: 1000,
  ...
  test.skip('initiateBankTransfer: required and optional params', async () => {
    const response = await client.v1.bila.transfers.initiateBankTransfer({
      accountId: '68f11209-451f-4a15-bfcd-d916eb8b09f4',
      amount: 1000,
      reference: 'transfer-001',
  ...
  test.skip('initiateMobileMoneyTransfer: only required params', async () => {
    const responsePromise = client.v1.bila.transfers.initiateMobileMoneyTransfer({
      amount: 250,
      country: 'zm',
      operator: 'airtel',
      phone: '0977433571',
  ...
  test.skip('initiateMobileMoneyTransfer: required and optional params', async () => {
    const response = await client.v1.bila.transfers.initiateMobileMoneyTransfer({
      amount: 250,
      country: 'zm',
      operator: 'airtel',
      phone: '0977433571',
