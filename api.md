...
- <code><a href="./src/resources/v1/bila/webhooks.ts">WebhookListDeliveriesResponse</a></code>
...
- <code title="get /api/v1/bila/webhooks/{id}/deliveries">client.v1.bila.webhooks.<a href="./src/resources/v1/bila/webhooks.ts">listDeliveries</a>(id, { ...params }) -> WebhookListDeliveriesResponse</code>
