...
```sh
npm install git+ssh://git@github.com:stainless-sdks/bila-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install bila`
...
const client = new Bila({
  apiKey: process.env['BILA_API_KEY'], // This is the default and can be omitted
...
1. Via the `BILA_LOG` environment variable
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/bila-typescript/issues) with questions, bugs, or suggestions.
